...
function getPayloadFromTransaction(transaction) {
	return (0, _solana_mobile_mobile_wallet_adapter_protocol_encoding.base64FromUint8Array)("version" in transaction ? transaction.serialize() : transaction.serialize({
